...
var Pj = _interopDefault(require('@pluginjs/factory'));
var utils = require('@pluginjs/utils');
var dom = require('@pluginjs/dom');
var events = require('@pluginjs/events');
var I18N = _interopDefault(require('@pluginjs/i18n'));
  ...
  return function (plugin) {
    ...
    plugin.prototype.trigger = function (eventType) {
      ...
      if (eventType instanceof Event) {
        ...
        events.trigger(this.selfEventName(eventType), this, ...params, this.element);
      }
  ...
  return function (plugin) {
    ...
    if (enableDataOption) {
      plugin.prototype.setupOptions = function () {
        ...
        this.options = utils.deepMerge(plugin.defaults, ...options, this.getDataOptions());
      };
