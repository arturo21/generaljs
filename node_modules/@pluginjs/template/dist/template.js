...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@pluginjs/utils')) :
  typeof define === 'function' && define.amd ? define(['@pluginjs/utils'], factory) :
  (global = global || self, global['@pluginjs/template'] = factory(global['@pluginjs/utils']));
  ...
  function render(string) {
    ...
    return string.replace(pattern, function (match, i, index) {
      ...
      if (Object.prototype.hasOwnProperty.call(args, i)) {
        ...
        result = utils.getValueByPath(args, i);
      }
  ...
  var main = {
    ...
    compile: function compile(str) {
      return function () {
        ...
        return render.apply(void 0, [str].concat(args));
      };
    },
