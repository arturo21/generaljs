 ...
 */
import { camelize, dasherize, curryWith } from '@pluginjs/utils';
import { isString, isElement, isNumeric, isObject, isArray, isWindow, isDocument } from '@pluginjs/is';
...
var css = curryWith((key, value, el) => {
  if (isElement(value) && typeof el === 'undefined') {
    el = value;
    value = undefined;
  }
...
var setOffset = (coordinates, el) => {
  var props = {};
  var parentOffset = offset(offsetParent(el));
...
export { css, getDefaultView, getHeight, getOffset, getStyle, getWidth, height, hideElement, innerHeight, innerWidth, isCSSVariable, offset, outerHeight, outerWidth, position, setHeight, setOffset, setStyle, setWidth, showElement, width };
