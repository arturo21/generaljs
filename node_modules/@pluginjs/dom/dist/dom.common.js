...
var find = utils.curry((selector, parent) => parent.querySelector(selector));
var findAll = utils.curry((selector, parent) => Array.from(parent.querySelectorAll(selector)));
...
var prevWith = utils.curry((fn, el) => {
...
var nextWith = utils.curry((fn, el) => {
...
var parentWith = utils.curry((fn, el) => {
...
var data = utils.curryWith((key, value, el) => {
...
var attr = utils.curryWith((args, value, el) => {
  if (is.isElement(value) && typeof el === 'undefined') {
    el = value;
    value = undefined;
  }
...
var removeAttr = utils.curry((attrs, el) => {
...
var prop = utils.curryWith((props, value, el) => {
  if (is.isElement(value) && typeof el === 'undefined') {
    el = value;
    value = undefined;
  }
...
var removeProp = utils.curry((props, el) => {
...
var clone = utils.curry(el => el.cloneNode(true));
var detach = utils.curry(el => {
  if (el.parentNode) {
...
var remove = utils.curry(el => el.remove());
var empty = utils.curry(el => {
  while (el.lastChild) {
...
var html = utils.curryWith((content, el) => {
...
var text = utils.curryWith((content, el) => {
  if (!is.isString(content) && typeof el === 'undefined') {
    el = content;
    content = undefined;
  }
...
var append = utils.curry((child, el) => {
...
var appendTo = utils.curry((child, el) => {
  if (is.isString(child)) {
...
var prepend = utils.curry((child, el) => {
  if (is.isString(child)) {
...
var prependTo = utils.curry((child, el) => {
  if (is.isString(child)) {
    child = parseHTML(child);
  }
...
var before = utils.curry((newElement, el) => {
...
var insertBefore = utils.curry((newElement, el) => {
  if (is.isString(newElement)) {
...
var after = utils.curry((newElement, el) => {
  if (is.isString(newElement)) {
...
var insertAfter = utils.curry((newElement, el) => {
  if (is.isString(newElement)) {
    newElement = parseHTML(newElement);
  }
...
var wrap = utils.curry((wrapElement, el) => {
...
var wrapInner = utils.curry((newElement, el) => {
  if (is.isString(newElement)) {
    newElement = parseHTML(newElement);
  }
...
var wrapAll = utils.curry((wrapElement, elementList) => {
  if (is.isString(wrapElement)) {
    wrapElement = parseHTML(wrapElement);
  }
...
var unwrap = utils.curryWith((selector, el) => {
  if (!is.isString(selector) && typeof el === 'undefined') {
    el = selector;
    selector = undefined;
  }
...
var replace = utils.curry((newContent, el) => {
